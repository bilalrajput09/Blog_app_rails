...
RSpec.describe User, type: :feature do
    ...
    let(:person2) do
        User.new(name: "Ashna", photo: "https://unsplash.com/photos/F_-0BxGuVvo", bio: "I am full stack developer", posts_counter: 0)
    end
    ...
    let(:second_post) do
        Post.new(author_id: person1.id, title: "Hello-2 this is the second post", text: "Most important description-2", likes_counter: 0, comments_counter: 0)
    end
